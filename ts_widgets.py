...
class id_and_parent_column_selector(tk.Frame):
    def __init__(self,
        ...
        self.par_col_selection = Sheet(self,
                                       ...
                                       show_selected_cells_border = False,
                                              header_align="center",
                                              row_index_align="center",
                                              table_selected_cells_bg="#8cba66",
                                       table_selected_cells_fg = "white",
                                       header_selected_cells_fg="white",
                                         index_selected_cells_fg="white",
                                              header_selected_cells_bg="#8cba66",
                                              index_selected_cells_bg="#8cba66",
                                              header_font = ("Calibri", 13, "normal"),
                                              column_width=170,
                                              row_index_width=60,
    ...
    def change_theme(self, theme = "dark blue"):
        ...
        self.id_col_selection.set_options(table_selected_cells_bg="#0078d7",
                                            table_selected_cells_fg = "white",
                                            header_selected_cells_fg="white",
                                            index_selected_cells_fg="white",
                                            header_selected_cells_bg="#0078d7",
                                            index_selected_cells_bg="#0078d7")
        self.par_col_selection.set_options(table_selected_cells_bg="#8cba66",
                                            table_selected_cells_fg = "white",
                                            header_selected_cells_fg="white",
                                            index_selected_cells_fg="white",
                                            header_selected_cells_bg="#8cba66",
